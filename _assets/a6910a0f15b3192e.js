(self["webpackChunk_canva_web"] = self["webpackChunk_canva_web"] || []).push([
  [86064],
  {
    /***/ 293444: function (_, __, __webpack_require__) {
      ...
      (function (__c) {
        var j5b;
        __c.d_ = function (a, b, c) {
          return new __c.Ab(a, c ? __c.Bb(c) : void 0, __c.Eaa, {
            ignoreTag: !0,
          }).format(Object.fromEntries(Object.entries(b)));
        };
        __c.i5b = function (a, b) {
          __c.w(!0);
          __c.w(!0);
          __c.w(!0);
          const { oa: c, a: d, b: e } = __c.ot(a),
            { oa: f, a: g, b: h } = __c.ot(b);
          a = (c + f) / 2;
          ...
          var k = d * (1 + b),
            ...
            n = Math.hypot(l, h);
          b = (m + n) / 2;
          var p = __c.Ct((Math.atan2(e, k) * 180) / Math.PI);
          const q = __c.Ct((Math.atan2(h, l) * 180) / Math.PI);
